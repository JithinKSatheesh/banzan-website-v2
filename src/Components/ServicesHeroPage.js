        ...
        return(
            ...
            <div className="h4 p-2 mb-4 ">
                <animated.div 
                    ...
                    <div 
                        style={{borderRadius:'5px',backgroundColor:'#fcc812'}}
                        className="col-9 d-flex align-items-center  text-dark">
                        &nbsp; {name}
                    </div>
                </animated.div>
            ...
            <div className="row">
                ...
                <div className="col-12 col-md-6">
                    <Slide top >
                        <animated.div 
                            style={{transform:scrollPos.to(transfromSlide_N1)}}
                            className="display-4 text-bold text-white">
                ...
                <div className="col-12">
                    ...
                    <div className="d-flex align-items-end">
                        ...
                        <animated.div 
                            ...
                            className="h1 text-bold text-white">
                            OUR SERVICES
                            &nbsp;
                            {/* {_arrow_down} */}
                        </animated.div>
