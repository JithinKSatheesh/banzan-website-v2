...
export default function Store(props) {
    ...
    return (
        ...
        <div className="Maincontainer">
            <Helmet>
                <title>Banzan Studios - Store - | BaBlah t-shirts |  cups |  books  </title>
                    ...
                    <animated.div 
                        ...
                        className="text-center">
                            <div className="space-100"></div>
                                <RenderImage image={_store_shirt_1} alt={"bablah printed shirt chocolate"}/>
                                <RenderImage image={_store_cup} alt={"bablah printed cup one"} />
                                <RenderImage image={_store_shirt_2} alt={"bablah printed shirt sky blue"} />
                                <RenderImage image={_store_book} alt={"bablah printed book black"} />
                                <RenderImage image={_store_shirt_6} alt={"bablah printed shirt space grey"} />
                                <RenderImage image={_store_badge} alt={"bablah printed shirt one"} />
                                <RenderImage image={_store_shirt_5} alt={"bablah printed shirt light grey"} />
                                <RenderImage image={_store_shirt_8} alt={"bablah printed shirt white"} />
                                <RenderImage image={_store_cup_2} alt={"bablah printed cup forest "} />
                                <RenderImage image={_store_shirt_3} alt={"bablah printed shirt dark grey"} />
                                <RenderImage image={_store_shirt_4} alt={"bablah printed shirt sunrise"} />
                                <RenderImage image={_store_book_2} alt={"bablah printed book kung fu"} />
                    </animated.div>
                    <animated.div 
                        style={{transform: scrollPos.to(transfromSlide_N1)}}
