        ...
        <div 
            ...
            <div className="row">
                ...
                <div className="col-12 col-md-6">
                    <Slide top >
                        <h1 className="display-3 text-bold text-dark text-center text-md-start">
                            Labs
                        </h1>
                    </Slide>
                    <div className="space-50"></div>
                    <Slide bottom >
                        <animated.h2 
                            ...
                            className={`text-bold h6 line-25  text-center text-md-start  `} >
                            When we aren’t seriously making a FUN product, we have fun experimenting with crazy ideas.
                    ...
                    <Fade>
                        <div
                            ...
                            <animated.img 
                                ...
                                className='img-fluid d-none d-md-block' src={_games_ellipse_small} alt="banzan studios labs ellipse" />
                            <animated.img 
                                style={{
                                    transform:scrollPos.to(transfromSlide_NN1), 
                            ...
                            <animated.img
                                ...
                                src={_ellipse}
                                className="img-fluid" alt="banzan studios labs ellipse" />
                            <animated.img
                                style={{ 
                                    position: 'absolute' ,
                                ...
                                src={_test_tube}
                                className="img-fluid" alt="banzan studios labs test tube image" />
                        </div>
                    </Fade>
                </div>
                <div className="col-12">
