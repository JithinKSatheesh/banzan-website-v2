    ...
    return (
        <div style={_style.game_hero_container}>
            ...
            <div className="flex flex-wrap sm:flex-nowrap pt-[50px]">
                ...
                <div className=" w-full  text-[16px] leading-[32px] font-bold text-center text-md-start">
                    <div className=''>
                        More than 25 Games and Mini-Games across multiple-genre to have fun with. <br/>
                    </div>
